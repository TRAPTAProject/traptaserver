    ...
    ui(new Ui::DialogBox)
{
    ...
    switch (icon) {
        case 0 : {
            ui->iconLabel->setPixmap(QPixmap(":/tango-idea.png"));
            break;
        }
        case 1 : {
            ui->iconLabel->setPixmap(QPixmap(":/tango-info.png"));
            break;
        }
        case 2 : {
            ui->iconLabel->setPixmap(QPixmap(":/tango-question.png"));
            break;
        }

        case 3 : {
            ui->iconLabel->setPixmap(QPixmap(":/tango-warning.png"));
            break;
        }
        case 4 : {
            ui->iconLabel->setPixmap(QPixmap(":/tango-critical.png"));
            break;
        }
    }
}
